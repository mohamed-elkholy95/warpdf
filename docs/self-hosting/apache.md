...
```bash
sudo mkdir -p /var/www/Wrapdf
sudo cp -r dist/* /var/www/Wrapdf/
sudo chown -R www-data:www-data /var/www/Wrapdf
```

## Step 3: Apache Configuration

Create `/etc/apache2/sites-available/Wrapdf.conf`:
...
<VirtualHost *:443>
    ServerName your-domain.com
    DocumentRoot /var/www/Wrapdf

    SSLEngine on
    SSLCertificateFile /etc/letsencrypt/live/your-domain.com/fullchain.pem
    SSLCertificateKeyFile /etc/letsencrypt/live/your-domain.com/privkey.pem

    <Directory /var/www/Wrapdf>
...
Create `/var/www/Wrapdf/.htaccess`:
...
```bash
sudo chown -R www-data:www-data /var/www/Wrapdf
sudo chmod -R 755 /var/www/Wrapdf
```
