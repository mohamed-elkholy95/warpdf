...
Wrapdf now uses nginx-unprivileged for enhanced security. This follows the Principle of Least Privilege and is essential for production environments.
...
# Run the container
docker run -p 8080:8080 Wrapdf-simple
```
