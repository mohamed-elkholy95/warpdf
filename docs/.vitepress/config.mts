...
export default defineConfig({
    title: "Wrapdf Docs",
    description: "Documentation for Wrapdf - The free, open-source, privacy-first PDF toolkit",
    base: '/docs/',
