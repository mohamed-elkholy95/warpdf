...
Wrapdf uses **i18next** for internationalization (i18n). Currently supported languages:
...
```json
{
  "faq.analytics.answer": "We care about your privacy. Wrapdf does not track personal information. We use <a href=\"https://simpleanalytics.com\" class=\"text-indigo-400 hover:underline\" target=\"_blank\" rel=\"noopener noreferrer\">Simple Analytics</a> solely to see anonymous visit counts."
}
```
