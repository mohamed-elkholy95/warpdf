...
::: warning Large Files
Vercel's serverless functions have a 50MB limit. Since Wrapdf is a static site, this shouldn't affect you, but WASM modules are large (~100MB total). Ensure they're served from the `/public` folder.
:::
