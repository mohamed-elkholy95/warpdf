/*
 * coherentpdf.global.d.ts — TypeScript type definitions for Wrapdf / CoherentPDF integration
 *
 * These type definitions were written by Mohamed Elkholy for use in the Wrapdf project.
